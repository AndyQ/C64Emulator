...
class DiskViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet var showEditorButton : UIButton!
    ...
    @IBAction func showEditorPressed(_ sender: AnyObject) {
...
*/
        ...
        webUploader.startServer(uploadFolder: getUserGamesDirectory())
    ...
    func moveInternalGamesIfAny( ) -> [String] {
        guard let gamesFolder = self.gamesFolder else  { return [] }
        var disks = [String]()

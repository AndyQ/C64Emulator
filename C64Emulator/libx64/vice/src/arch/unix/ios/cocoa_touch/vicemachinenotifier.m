...
-(id)initWithOwner:(id<VICEApplicationProtocol>)owner;
{
    _owner = owner;
                                  ...
                                  pwm2:(unsigned int)pwm2
{
    NSDictionary * dict =
        [NSDictionary dictionaryWithObjectsAndKeys:
            [NSNumber numberWithInt:drive], @"drive",
            [NSNumber numberWithInt:pwm1], @"pwm",
            nil, nil];
                    ...
                    userInfo:(NSDictionary *)userInfo
{
    ...
    if (_owner != nil)
        [(NSObject*)_owner performSelectorOnMainThread:@selector(postRemoteNotification:) withObject:array waitUntilDone:NO];
}

                                    ...
                                    const char *image)
{
    ...
    [theVICEMachine setDriveImageName:[string lastPathComponent]];
...
{
    //NSLog(@"%.1f%%, %.1f FPS", speed, frame_rate);

    NSDictionary* warpInfo = [NSDictionary dictionaryWithObject:[NSNumber numberWithInt:warp_enabled] forKey:@"warp_enabled"];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"WarpStatus" object:nil userInfo:warpInfo];
}
